...
-- Date        : Thu Jul  7 16:41:04 2022
-- Host        : PC-Huang running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               P:/Project/iverilog/Exp/pipeline/cpu.srcs/sources_1/ip/prgrom/prgrom_sim_netlist.vhdl
-- Design      : prgrom
...
\synth_options.dist_mem_inst\: entity work.prgrom_dist_mem_gen_v8_0_12_synth
     port map (
      a(13 downto 0) => a(13 downto 0),
      spo(10) => \^spo\(2),
      spo(9 downto 8) => \^spo\(21 downto 20),
      spo(7 downto 5) => \^spo\(17 downto 15),
      spo(4 downto 2) => \^spo\(9 downto 7),
      spo(1) => \^spo\(4),
      spo(0) => \^spo\(1)
    );
end STRUCTURE;
